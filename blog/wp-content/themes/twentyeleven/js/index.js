...
$(document).ready(function() {
	...
	scrollorama.onBlockChange(function() {
				...
				{$('nav ul li a').removeClass('menuactive');
				 $('nav ul li:nth-child(0)').addClass('menuactive');}
				if(i==1)
				{ $('nav ul li a').removeClass('menuactive');
				$('nav ul li:nth-child(1)').removeClass('menuactive');
				...
				if(i==4)
				{ $('nav ul li a').removeClass('menuactive');
				$('nav ul li:nth-child(5)').children().addClass('menuactive');}
	...
	//	scrollorama.animate('.fadeIn2',{ delay:500, duration:500, property:'letter-spacing', start:20});
		...
		scrollorama.animate('.fadeIn5',{ delay:800, duration:300, property:'opacity', start:0});
		
		scrollorama.animate('.fadeIn6',{ delay:800, duration:200, property:'opacity', start:0});
		
		scrollorama.animate('.fadeIn7',{ delay:800, duration:200, property:'opacity', start:0});
		
		scrollorama.animate('.fadeIn8',{ delay:800, duration:200, property:'opacity', start:0});
		
		scrollorama.animate('.fadeIn9',{ delay:800, duration:150, property:'opacity', start:0});
		scrollorama.animate('.fadeIn10',{ delay:800, duration:150, property:'opacity', start:0});
		scrollorama.animate('.fadeIn11',{ delay:800, duration:150, property:'opacity', start:0});
		scrollorama.animate('.fadeIn12',{ delay:800, duration:150, property:'opacity', start:0});
